...
tests <- 30393 #c(12370,9702,7903,7992,6875,6398,3213)
sum(tests)
...
tableau <- t(tableau)
print(xtable(tableau,digits=0),file='Tableaux-Figures/covid-prevalence-vague2.tex')
tableau
...
ggplot(fig) +
  ...
  theme_bw()
ggsave('Tableaux-Figures/prevalence-covid-vague2.png',dpi=1200)

saveRDS(fig,file="Tableaux-Figures/tableauV2.Rda")
