* Préparation de la base d'analyse (vague 17)
...
import excel using "Brut\MW14273_028A-VAGUE17.xlsx", sheet("MW14273_028A-VAGUE17") firstrow
...
label var ResultPos_foyer_miDec "nb de personnes du foyer positif COVID (depuis mi-déc pour T4-T15)"
tab ResultPos_foyer_miDec
********************
tab Q13Ar1
rename Q13Ar1 ResultPos_enf0_4_miDec
label var ResultPos_enf0_4_miDec "nb d'enfants (0-4 ans) poitif COVID (depuis mi-déc pour T4-T15)"
tab ResultPos_enf0_4_miDec
********************
tab Q13Ar2
rename Q13Ar2 ResultPos_enf5_12_miDec
label var ResultPos_enf5_12_miDec "nb d'enfants (5-12 ans) positif COVID (depuis mi-déc pour T4-T15)"
tab ResultPos_enf5_12_miDec
********************
tab Q13Ar3
rename Q13Ar3 ResultPos_enf13_17_miDec
label var ResultPos_enf13_17_miDec "nb d'enfants (13-17 ans) positif COVID (depuis mi-déc pour T4-T15)"
...
label var ResultPos_enfantTotal_miDec "nb d'enfants (0-17 ans) positif COVID (depuis mi-déc pour T4-T15)" 
tab ResultPos_enfantTotal_miDec
*********************************************************************
tab Q14AA
label var Q14AA "a déjà été infecté par la COVID-19 dans le passé (1)"
...
tab Q14
label var Q14 "a déjà été infecté par la COVID-19 dans le passé (2)"
...
replace ResultPos_miDec1 = 1 if semaine>=16 & Infection_passee >= 3
...
order record eventdate semaine region region1 region2 CP LangueQuest LangueMat *_langue femme age age_1 age_2 age_3 nbfam nbenf_a* educ4 educ3 revenu sit_emploi emploi_temps_plein emploi_temps_partiel emploi_salarie emploi_autonome travailleur etudiant foyer chomeur retraite mstat  travail_lieu secteur secteur_1 symptome_* nb_symptomes po_symptomes
...
label data "Enquête CIRANO-Léger sur la prévalence de la COVID-19, 11 mai 2022"

saveold "C:\Users\Alexandre Prud'homme\Dropbox\EnqueteCOVID\Propre\cirano_leger_covid_17.dta", replace version(11)
