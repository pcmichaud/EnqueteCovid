* Preparation de la base d'analyse (vague 12)
...
import excel using "Brut\MW14273_028A-VAGUE12.xlsx", sheet("MW14273_028A-VAGUE12") firstrow
...
label data "Enquête CIRANO-Léger sur la prévalence de la COVID-19, 6 avril 2022"

saveold "C:\Users\Alexandre Prud'homme\Dropbox\EnqueteCOVID\Propre\cirano_leger_covid_12.dta", replace version(11)
